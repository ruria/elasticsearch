...
public class MapperServiceTests extends ESSingleNodeTestCase {
    ...
    public void testIndexIntoDefaultMapping() throws Throwable {
        ...
        try {
            ...
            final Throwable unwrapCause = ((ElasticsearchException) t).unwrapCause();
            if (unwrapCause instanceof IllegalArgumentException) {
                assertEquals("It is forbidden to index into the default mapping [_default_]", unwrapCause.getMessage());
            } else {
                throw t;
            }
        }
